...
public class DbAccessManager {
    ...
    public List<String> getAllNationalities()  {
        ...
        try {
            String query = "SELECT nationality FROM pilots";
            ResultSet rs = conn.createStatement().executeQuery(query);
            while (rs.next()) {
                if(!nationalities.contains(rs.getString("nationality")))
    ...
    public List<Pilot> getPilotsByName(String pilotName){
